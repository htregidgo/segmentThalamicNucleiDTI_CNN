...
def main():
    ...
    validate_ablation_06(top_level_dir=args.top_dir, N_subjects=args.N_subjects)


def validate_ablation_06( top_level_dir, N_subjects ) :
    ...
    model_name = 'joint_thalamus_ablation_06'
